...
const customStyles = {
  ...
  title: "text-6xl text-gold font-body font-normal flex justify-center ",
  main: "flex flex-1 flex-col justify-center align-center",
}
const Home: NextPage = () => {
  return (
    <div className={customStyles.container}>
      ...
      <main className={customStyles.main}>
        ...
        <a>Welcome to Social Gamble</a>
        </h1>

        <p className={styles.description}>
          Get started by editing{' '}
          <code className={customStyles.code}>pages/index.tsx</code>
        </p>
